<?php /* Smarty version Smarty-3.1.18, created on 2017-09-25 00:59:32
         compiled from "backend\design\html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:818659ac6a88eb90b7-39887425%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '818659ac6a88eb90b7-39887425',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_59ac6a898ba064_75536121',
  'variables' => 
  array (
    'product' => 0,
    'btr' => 0,
...
<?php if ($_valid && !is_callable('content_59ac6a898ba064_75536121')) {function content_59ac6a898ba064_75536121($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\OpenServer\\domains\\simpla.test\\Smarty\\libs\\plugins\\modifier.truncate.php';
        ...
        <div class="col-lg-12 col-md-12 ">
            <div class="boxed fn_toggle_wrap match_matchHeight_true">
                <div class="heading_box">
                    ...
                    <!-- Переключатель типа вывода товаров -->
                    <div class="activity_of_switch_item"> 
                        <div class="okay_switch clearfix">
                            <label class="switch_label">Вариант вывода товара (выкл. - выпадающий список / вкл. - радиобаттон) </label>
                            <label class="switch switch-default">
                                <input class="switch-input" name="variant_view" value="1" type="checkbox" id="visible_checkbox" <?php if ($_smarty_tpl->tpl_vars['product']->value->variant_view) {?>checked<?php }?>>
                                <span class="switch-label"></span>
                                <span class="switch-handle"></span>
                            </label>
                        </div>
...
" <?php if ($_smarty_tpl->tpl_vars['currency']->value->id==$_smarty_tpl->tpl_vars['variant']->value->currency_id) {?>selected=""<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currency']->value->code, ENT_QUOTES, 'UTF-8', true);?>
</option>
                                                <?php } ?>
                                            </select>
                                        </div>
...
">
                ...
                <div class="toggle_body_wrap on fn_card okay_disabled">
...
" type="text" name="options[<?php echo $_smarty_tpl->tpl_vars['feature_id']->value;?>

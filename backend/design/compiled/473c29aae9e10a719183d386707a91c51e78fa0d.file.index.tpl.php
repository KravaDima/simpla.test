<?php /* Smarty version Smarty-3.1.18, created on 2017-09-03 23:46:36
         compiled from "backend\design\html\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:601259ac6a2c64ba62-07940548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '601259ac6a2c64ba62-07940548',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ac6a2c983ea4_59326931',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ac6a2c983ea4_59326931')) {function content_59ac6a2c983ea4_59326931($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\OpenServer\\domains\\simpla.test\\Smarty\\libs\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    ...
    <?php if ($_GET['module']=="OrdersAdmin") {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value->gather_enabled) {?>
        ...
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
                    ...
                    })(window,document,'script','dataLayer','GTM-WNXSMRR');
        </script>
...
<body class="navbar-fixed <?php if ($_smarty_tpl->tpl_vars['manager']->value->menu_status&&$_smarty_tpl->tpl_vars['is_mobile']->value===false&&$_smarty_tpl->tpl_vars['is_tablet']->value===false) {?>menu-pin<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value->gather_enabled) {?>
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WNXSMRR" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <?php }?>
...
<?php }?>">
 ...
 title"><?php echo $_smarty_tpl->tpl_vars['btr']->value->{$_smarty_tpl->tpl_vars['section']->value};?>
</span>
...
">
                                                    <span class="icon-thumbnail">
                                                        <?php $_smarty_tpl->tpl_vars["letter"] = new Smarty_variable($_smarty_tpl->tpl_vars['btr']->value->{$_smarty_tpl->tpl_vars['title']->value}, null, 0);?>
                                                        <?php echo $_smarty_tpl->tpl_vars['letter']->value[0];?>
<?php echo $_smarty_tpl->tpl_vars['letter']->value[1];?>

                                                    </span>
                                                    <span class="<?php echo $_smarty_tpl->tpl_vars['title']->value;?>
 title"><?php echo $_smarty_tpl->tpl_vars['btr']->value->{$_smarty_tpl->tpl_vars['title']->value};?>
</span>
                                                </a>
                                            </li>
                                        <?php } ?>
...
?logout">
                    ...
                    <div class="admin_techsupport">
                        <div class="techsupport_inner">
                            <a <?php if ($_smarty_tpl->tpl_vars['support_info']->value->public_key) {?> data-hint="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['balance'][0][0]->balance_modifier($_smarty_tpl->tpl_vars['support_info']->value->balance,false);?>
"<?php } else { ?> data-hint="Not active" <?php }?>  class="hint-bottom-middle-t-info-s-small-mobile  hint-anim"  href="index.php?module=SupportAdmin">
                            ...
                            <div class="techsupport_toggle hidden-md-up">
                                <?php if ($_smarty_tpl->tpl_vars['support_info']->value->public_key) {?>
                                    <span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['balance'][0][0]->balance_modifier($_smarty_tpl->tpl_vars['support_info']->value->balance,false);?>
</span>
                                <?php } else { ?>

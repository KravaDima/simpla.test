                            ...
                            <div class="fn_row okay_list_body_item">
                                <div class="okay_list_row">
                                    ...
                                    <div class="okay_list_boding okay_list_orders_name">
                                        <a href="{url module=OrderAdmin id=$order->id return=$smarty.server.REQUEST_URI}" class="text_dark text_bold">{$order->name|escape} {$order->sername|escape}</a>
                                        {if $order->note} <!-- Добавлено отображение Фамилии -->

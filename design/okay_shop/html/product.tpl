                    ...
                    <form class="fn_variants" action="/{$lang_link}cart">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <!-- Начало -->
                                {if $product->variants|count < 2 || $product->variant_view != 1} 
                                    {include file="variant_select.tpl"} 
                                {else}
                                    {include file="variant_radio.tpl"}
                                {/if}                                
                                <!-- Конец -->
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6" {if $product->variant_view != 0} hidden{/if}>
                                {* Old price *}

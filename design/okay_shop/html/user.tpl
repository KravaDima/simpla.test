        ...
        <div class="col-lg-5">
            ...
            {if $error}
                <div class="message_error">
                    ...
                    {elseif $error == 'empty_sername'}
                        <span data-language="form_enter_sername">{$lang->form_enter_sername}</span>
            ...
            <form method="post" class="fn_validate_register">
                ...
                {* User's sername *}
                <div class="form_group">
                    <input class="form_input" value="{$sername|escape}" name="sername" type="text" data-language="form_sername" placeholder="{$lang->form_sername}*"/>
                </div>
                <!-- конец -->
                {* User's email *}
                <div class="form_group">

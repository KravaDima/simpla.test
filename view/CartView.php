...
class CartView extends View {
    ...
    public function __construct() {
        ...
        if(isset($_POST['checkout'])) {
            ...
            $order->sername     = $this->request->post('sername'); // Записываем Фамилию в заказ
            ...
            $this->design->assign('sername', $order->sername); //
            ...
            } elseif(!$this->validate->is_name($order->sername, true)) {    // Проверяем заполнено ли поле Фамилия
                $this->design->assign('error', 'empty_sername');
    ...
    public function fetch() {
        ...
        if($this->user) {
            ...
            if($last_order) {
                ...
                $this->design->assign('sername', $last_order->sername);
                ...
                $this->design->assign('sername', $this->user->sername);
